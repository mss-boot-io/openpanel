...
export const listOpenNodeOptions = () => {
    return http.get<Array<Setting.NodeItem>>(`/core/open-nodes/options`);
};
export const searchOpenNodes = (params: SearchWithPage) => {
    return http.post<ResPage<Setting.OpenNodeItem>>(`/core/open-nodes/search`, params);
};
export const createOpenNode = (params: Setting.OpenNodeOperate) => {
    return http.post(`/core/open-nodes`, params);
};
export const updateOpenNode = (params: Setting.OpenNodeOperate) => {
    return http.post(`/core/open-nodes/update`, params);
};
export const deleteOpenNode = (id: number) => {
    return http.post(`/core/open-nodes/del`, { id });
};
export const testOpenNode = (params: Partial<Setting.OpenNodeOperate>) => {
    return http.post<Setting.OpenNodeItem>(`/core/open-nodes/test`, params, TimeoutEnum.T_40S);
};
